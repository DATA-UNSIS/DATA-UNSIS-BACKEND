...
import com.example.dynamicSQLTest.builders.HomeworkDevicesQueryBuilder;
import com.example.dynamicSQLTest.enums.ETitles;
import com.example.dynamicSQLTest.processors.HomeworkDevicesResultProcessor;
...
@Service
public class HomeworkDevicesService {
    @PersistenceContext
    private EntityManager entityManager;

    @Autowired
    private HomeworkDevicesQueryBuilder queryBuilder;

    @Autowired
    private HomeworkDevicesResultProcessor resultProcessor;
